...
<ul class='compact'>
  ...
  <li><a href="{{route('systems.edit',$system->id)}}">{{$system->displayName()}}</a>
...
<ul class='compact'>
  ...
  <li><a href="{{route('factions.edit',$faction->id)}}">{{$faction->name}}</a>
...
<ul class='compact'>
  ...
  <li><a href="{{route('systems.editreport',$system->id)}}">{{$system->displayName()}}</a>
