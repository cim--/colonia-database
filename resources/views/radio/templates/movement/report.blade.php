...
@include('radio.templates.movement.expansion', ['expanding' => $parameters['expanding']])
@endif

@if ($parameters['retreating'])
@include('radio.templates.movement.retreat', ['retreating' => $parameters['retreating'], 'expanding' => $parameters['expanding']])
@endif
