  ...
  <thead>
	<tr>
      ...
      <th data-orderable='false'>
		<a href='{{route('systems.showhappiness', $system->id)}}'>{{$system->displayName()}}</a>
	  </th>
	  @endforeach
	</tr>
  </thead>
  <tbody>
	...
	<tr>
	  ...
	  <td>
        ...
        @include('icons/happiness',['happiness'=>$history[$date][$systemid][0], 'label'=>true])
		@else
