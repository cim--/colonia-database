...
<p>A large number of <a href='{{route('installations.index')'>installations</a>, <a href='{{route('megaships.index')'>mobile megaships</a> and <a href='{{route(sites.index')'>other sites</a> are present in the region, including the famous umbrella molluscs, and the Holloway experimental habitats.</p>
