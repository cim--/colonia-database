...
<p>With the construction of the Colonia Applied Research facility, the region is capable of producing <a href='{{route('outfitting')}}'>almost all outfitting components</a>, though availability will depend somewhat on local stock levels and economic situations. As the region is independent of the superpowers, the ships produced by these are not generally available.</p>
